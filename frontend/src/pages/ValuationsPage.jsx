      ...
      <div className="p-6 md:p-8 lg:p-12 max-w-6xl mx-auto">
        ...
        >
          <div className="w-20 h-20 rounded-2xl bg-[#F0F7FF] flex items-center justify-center mx-auto mb-6">
            <TrendingUp className="w-10 h-10 text-[#0B4DBB]" />
          </div>
          <h1 className="text-2xl md:text-3xl font-bold text-slate-900 mb-3">Valuations</h1>
          <p className="text-slate-600 max-w-md mx-auto mb-8">
            View all your valuations across projects. Compare scenarios, track changes, and analyze trends over time.
          </p>
          ...
          <div className="bg-gradient-to-br from-slate-50 to-white border border-slate-200 rounded-2xl p-8 max-w-lg mx-auto">
            ...
            <p className="text-slate-500 text-sm mb-6">
              This dedicated valuations view is under development. For now, access your valuations from project cards on the Dashboard.
            </p>
            <Link to="/dashboard">
